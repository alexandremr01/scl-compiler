...
static uint32_t setpa(unsigned int dest, unsigned int src, uint8_t imm) __attribute__ ((unused));
static uint32_t setpa(unsigned int dest, unsigned int src, uint8_t imm)
{
  return (bits(imm, 11, 0) << 20) |
    (src << 15) |
    (dest << 7) |
...
static uint32_t setpb(unsigned int dest, unsigned int src, uint8_t imm) __attribute__ ((unused));
static uint32_t setpb(unsigned int dest, unsigned int src, uint8_t imm)
{
  return (bits(imm, 11, 0) << 20) |
    (src << 15) |
    (dest << 7) |
...
static uint32_t addpa() __attribute__ ((unused));
static uint32_t addpa()
{
  return MATCH_ADDPA;
}

static uint32_t addpb() __attribute__ ((unused));
static uint32_t addpb()
{
  return MATCH_ADDPB;
}


static uint32_t macc(unsigned int dest, unsigned int src, uint8_t imm) __attribute__ ((unused));
static uint32_t macc(unsigned int dest, unsigned int src, uint8_t imm)
{
  return (bits(imm, 11, 0) << 20) |
    (src << 15) |
    (dest << 7) |
...
static uint32_t store(unsigned int dest, unsigned int src, uint8_t imm) __attribute__ ((unused));
static uint32_t store(unsigned int dest, unsigned int src, uint8_t imm)
{
  return (bits(imm, 11, 0) << 20) |
    (src << 15) |
    (dest << 7) |
...
static uint32_t relu(unsigned int dest, unsigned int src, uint8_t imm) __attribute__ ((unused));
static uint32_t relu(unsigned int dest, unsigned int src, uint8_t imm)
{
  return (bits(imm, 11, 0) << 20) |
    (src << 15) |
    (dest << 7) |
