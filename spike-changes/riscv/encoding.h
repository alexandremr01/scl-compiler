...
#define MATCH_MACC 0x0B
#define MATCH_SETPA 0x8B
#define MATCH_SETPB 0x10B
#define MATCH_STORE 0x18B
#define MATCH_ADDPA 0x20B
#define MATCH_SETACC 0x30B
#define MATCH_ADDPB 0x28B
#define MATCH_RELU 0x38B

#define MASK_MACC 0x7FF
#define MASK_SETPA 0x7FF
#define MASK_SETPB 0x7FF
#define MASK_STORE 0x7FF
#define MASK_ADDPA 0x7FF
#define MASK_ADDPB 0x7FF
#define MASK_RELU 0x7FF
#define MASK_SETACC 0x7FF
...
#endif
#ifdef DECLARE_INSN
DECLARE_INSN(macc, MATCH_MACC, MASK_MACC)
DECLARE_INSN(store, MATCH_STORE, MASK_STORE)
DECLARE_INSN(setpa, MATCH_SETPA, MASK_SETPA)
DECLARE_INSN(addpa, MATCH_ADDPA, MASK_ADDPA)
DECLARE_INSN(setacc, MATCH_SETACC, MASK_SETACC)
DECLARE_INSN(setpb, MATCH_SETPB, MASK_SETPB)
DECLARE_INSN(addpb, MATCH_ADDPB, MASK_ADDPB)
